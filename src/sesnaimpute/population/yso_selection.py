...
def build_and_write_region(config, region, st=None):
    ...
    path = config_module.product_path(config, "population", "yso", "selection", "source", region=region)
