...
PY sesnaimpute.atlas.shapes --page region   # the prior's mass in the nuisance plane, selection included: N_CAT_CELL_<C>/N_CELL_<C> per class, one page per region (report-only, SPEC_BMSTP sec 8)
